...
# mongodb+srv://madhubalan:madhubalan14@cluster0.2zfvx8b.mongodb.net/?retryWrites=true&w=majoritypython
mongoDB=pymongo.MongoClient('mongodb://localhost:27017')
db=mongoDB['SalesPrediction']
account=db.account

app=Flask(__name__)
app.secret_key="'\xbf\x96\xb1\x92*\x8e\xc9\xdc\xbf\xd6\x01\xc2\xe3\n%R\xc7'\x85\xef\x10\x08L\x8b"
CORS(app)
